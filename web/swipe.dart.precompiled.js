...
["dart.dom.html", "dart:html", , W, {
  ...
  Document: {
    ...
    get$onTouchEnd: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, C.EventStreamProvider_touchend._eventType, false), [null]);
    },
    get$onTouchMove: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, C.EventStreamProvider_touchmove._eventType, false), [null]);
    },
    get$onTouchStart: function(receiver) {
      return H.setRuntimeTypeInfo(new W._EventStream(receiver, C.EventStreamProvider_touchstart._eventType, false), [null]);
    },
  ...
  Element: {
    ...
    get$onTouchEnd: function(receiver) {
      return H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_touchend._eventType, false), [null]);
    },
    get$onTouchMove: function(receiver) {
      return H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_touchmove._eventType, false), [null]);
    },
    get$onTouchStart: function(receiver) {
      return H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(receiver, C.EventStreamProvider_touchstart._eventType, false), [null]);
    },
    $isElement: true,
    "%": ";Element"
  },
  ...
  UIEvent: {
    "": "Event;",
    "%": "CompositionEvent|DragEvent|FocusEvent|KeyboardEvent|MSPointerEvent|MouseEvent|MouseScrollEvent|MouseWheelEvent|PointerEvent|SVGZoomEvent|TextEvent|WheelEvent;UIEvent"
  },
  Window: {
    "": "EventTarget;",
    toString$0: function(receiver) {
...
["dart.math", "dart:math", , P, {
  ...
  Point: {
    ...
    $sub: function(_, other) {
      ...
      if (typeof t1 !== "number")
        return t1.$sub();
      t2 = new P.Point(t3, C.JSInt_methods.$sub(t1, t2));
      t2.$builtinTypeInfo = this.$builtinTypeInfo;
      return t2;
    },
    $isPoint: true
...
["swipe", "lib/swipe.dart", , V, {
  "": "",
  Swipe: {
    "": "Object;_container,_wrapper,_slides,slidePos,width,index,speed,disableScroll,_start,_delta,_time,_isScrolling",
    get$length: function(_) {
      return J.get$length$asx(this._slides);
    },
    _setup$0: function() {
      var t1, t2, t3, t4, pos, pos0, slide;
      t1 = this._container;
      ...
      t2 = t1.offsetWidth;
      this.width = t2;
      t3 = J.get$style$x(this._wrapper);
      t4 = J.get$length$asx(this._slides);
      if (typeof t2 !== "number")
        return t2.$mul();
      J.set$width$x(t3, "" + t2 * t4 + "px");
      pos = J.get$length$asx(this._slides);
      for (t2 = this.slidePos; pos0 = pos - 1, pos > 0; pos = pos0) {
        slide = J.$index$asx(this._slides, pos0);
        J.set$width$x(J.get$style$x(slide), H.S(this.width) + "px");
        t3 = C.JSInt_methods.toString$0(pos0);
        slide.setAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(slide))._toHyphenedName$1("index"), t3);
        t3 = this.index;
        if (t3 > pos0) {
          t3 = this.width;
          if (typeof t3 !== "number")
          ...
          t3 = t3 < pos0 ? this.width : 0;
        this._translate$3(pos0, t3, 0);
        t2.$indexSet(t2, pos0, t3);
      }
      J.set$visibility$x(t1.style, "visible");
    },
    _translate$3: function(index, dist, speed) {
      var t1;
      if (index < 0 || index > J.get$length$asx(this._slides) - 1)
        return;
      t1 = J.get$style$x(J.$index$asx(this._slides, index));
      J.getInterceptor$x(t1).set$transitionDuration(t1, "" + speed + "ms");
      C.CssStyleDeclaration_methods.set$transform(t1, "translate(" + H.S(dist) + "px, 0) translateZ(0)");
    },
    _circle$1: function(index) {
      return C.JSInt_methods.$mod(J.get$length$asx(this._slides) + C.JSInt_methods.$mod(index, J.get$length$asx(this._slides)), J.get$length$asx(this._slides));
    },
    _handleEvents$0: function() {
      var t1 = J.get$onTouchStart$x(this._wrapper);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(this.get$_startEvent()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onTouchMove$x(this._wrapper);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(this.get$_moveEvent()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onTouchEnd$x(this._wrapper);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(this.get$_stopEvent()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    _startEvent$1: [function($event) {
      var t1, t2;
      t1 = J.get$touches$x($event);
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      t1 = H.setRuntimeTypeInfo(new P.Point(t1.pageX, t1.pageY), [null]);
      t2 = $event.touches;
      if (0 >= t2.length)
        return H.ioore(t2, 0);
      t2 = t2[0];
      this._start = new V.Vector(t1.x, H.setRuntimeTypeInfo(new P.Point(t2.pageX, t2.pageY), [null]).y);
      this._time = P.DateTime$_now().millisecondsSinceEpoch;
      this._isScrolling = null;
    }, "call$1", "get$_startEvent", 2, 0, 18],
    _stopEvent$1: [function($event) {
      var t1, t2, isValidSlide, isPastBounds, t3, t4;
      if (this._delta == null || this._isScrolling === true)
        return;
      if (P.DateTime$_now().millisecondsSinceEpoch - this._time < 250) {
        t1 = this._delta.x;
        t1.toString;
        t1 = Math.abs(t1) > 20;
      } else
      ...
      if (t1 === 0) {
        ...
        t2 = false;
      if (!t2)
        if (t1 === J.get$length$asx(this._slides) - 1) {
          t1 = this._delta.x;
          if (typeof t1 !== "number")
            return t1.$lt();
          t1 = t1 < 0;
      ...
      if (isValidSlide && !isPastBounds) {
        ...
        if (t1 < 0) {
          ...
          if (typeof t3 !== "number")
            return t3.$negate();
          t3 = -t3;
          this._translate$3(t1, t3, 0);
          t2 = this.slidePos;
          t2.$indexSet(t2, t1, t3);
          t3 = this.index;
          t1 = J.$sub$n(t2.$index(t2, t3), this.width);
          t4 = this.speed;
          this._translate$3(t3, t1, t4);
          t2.$indexSet(t2, t3, t1);
          t1 = this._circle$1(this.index + 1);
          t3 = J.$sub$n(t2.$index(t2, this._circle$1(this.index + 1)), this.width);
          this._translate$3(t1, t3, t4);
          t2.$indexSet(t2, t1, t3);
          this.index = this._circle$1(this.index + 1);
        } else {
          t1 = t2 + 1;
          this._translate$3(t1, t3, 0);
          t2 = this.slidePos;
          t2.$indexSet(t2, t1, t3);
          t3 = this.index;
          t1 = J.$add$ns(t2.$index(t2, t3), this.width);
          t4 = this.speed;
          this._translate$3(t3, t1, t4);
          t2.$indexSet(t2, t3, t1);
          t1 = this._circle$1(this.index - 1);
          t3 = J.$add$ns(t2.$index(t2, this._circle$1(this.index - 1)), this.width);
          this._translate$3(t1, t3, t4);
          t2.$indexSet(t2, t1, t3);
          this.index = this._circle$1(this.index - 1);
        }
        ...
        t2 = -t2;
        t3 = this.speed;
        this._translate$3(t1, t2, t3);
        t4 = this.slidePos;
        t4.$indexSet(t4, t1, t2);
        t2 = this.index;
        this._translate$3(t2, 0, t3);
        t4.$indexSet(t4, t2, 0);
        t2 = this.index + 1;
        t1 = this.width;
        this._translate$3(t2, t1, t3);
        t4.$indexSet(t4, t2, t1);
      }
    }, "call$1", "get$_stopEvent", 2, 0, 19],
    _moveEvent$1: [function($event) {
      var t1, t2, t3, t4;
      ...
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      t1 = H.setRuntimeTypeInfo(new P.Point(t1.pageX, t1.pageY), [null]).x;
      t2 = this._start.x;
      if (typeof t1 !== "number")
        return t1.$sub();
      if (typeof t2 !== "number")
      ...
      if (0 >= t1.length)
        return H.ioore(t1, 0);
      t1 = t1[0];
      t1 = H.setRuntimeTypeInfo(new P.Point(t1.pageX, t1.pageY), [null]).y;
      t3 = this._start.y;
      if (typeof t1 !== "number")
        return t1.$sub();
      if (typeof t3 !== "number")
        return H.iae(t3);
      this._delta = new V.Vector(t2, t1 - t3);
      t1 = this._isScrolling;
      if (t1 == null) {
        t1 = Math.abs(t2);
        t2 = this._delta.y;
        t2.toString;
        t2 = t1 < Math.abs(t2);
        this._isScrolling = t2;
        t1 = t2;
      }
      if (t1 === true)
        return;
      ...
      if (typeof t4 !== "number")
        return H.iae(t4);
      this._translate$3(t1, t2 + t4, 0);
      if (this.index < J.get$length$asx(this._slides) - 1) {
        t1 = this.index + 1;
        t2 = this._delta.x;
        t3 = t3.$index(t3, t1);
        if (typeof t2 !== "number")
...
["", "swipe.dart", , A, {
  "": "",
  main: [function() {
    var t1 = new V.Swipe(document.querySelector("#slider"), null, H.setRuntimeTypeInfo([], [W.Element]), P.LinkedHashMap_LinkedHashMap(null, null, null, J.JSInt, J.JSInt), null, 2, 300, false, null, null, 0, null);
    t1._setup$0();
    t1._handleEvents$0();
    $.swipe = t1;
...
function dart_precompiled($collectedClasses) {
  ...
  function Swipe(_container, _wrapper, _slides, slidePos, width, index, speed, disableScroll, _start, _delta, _time, _isScrolling) {
    ...
    this._delta = _delta;
    this._time = _time;
    this._isScrolling = _isScrolling;
  }
  Swipe.builtin$cls = "Swipe";
  if (!"name" in Swipe)
    Swipe.name = "Swipe";
  $desc = $collectedClasses.Swipe;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Swipe.prototype = $desc;
  function Vector(x, y) {
    this.x = x;
    this.y = y;
  }
